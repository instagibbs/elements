...
BOOST_AUTO_TEST_CASE(witness_valid)
{
    ...
    CScript fedpegscript(ParseHex(fedpegscript_str));
    ...
    CBlockIndex* pindex = LookupBlockIndex(coins.GetBestBlock());
    BOOST_CHECK(Consensus::CheckTxInputs(tx, state, coins, pindex, 0, fee_map, setPeginsSpent, NULL, false, true));
    ...
    BOOST_CHECK(!Consensus::CheckTxInputs(tx2, state, coins, pindex, 0, fee_map, setPeginsSpent, NULL, false, true));
    ...
    BOOST_CHECK(!Consensus::CheckTxInputs(tx3, state, coins, pindex, 0, fee_map, setPeginsSpent, NULL, false, true));
    BOOST_CHECK(setPeginsSpent.empty());
